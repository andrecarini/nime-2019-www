...
if (youtube_placeholder) {
	...
	youtube_placeholder_img.setAttribute( "src", "images/photos/youtube_placeholders/index_yt_placeholder.jpg" );
...
// Show/hide registration submission sticky header
...
var navButtonText = document.getElementById('navButtonText');
var navNimeLogo = document.getElementById('navNimeLogo');
...
function showHideNavPanel() {
  if (panel_is_visible == 0) {
		...
		navButtonText.classList.remove("visible");
		setTimeout( function() {
		...
		navButtonText.style.display = 'flex';
		setTimeout( function() {
		  navButtonText.classList.add("visible");
		}, 20);
		setTimeout( function() {
...
navNimeLogo.addEventListener( "click", function() {
	showHideNavPanel();
}, false);
